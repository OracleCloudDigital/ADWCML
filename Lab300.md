...
* Object Store의 데이터에 액세스하려면 OCI Object Store 계정 및 Auth 토큰을 사용하여 데이터베이스 사용자가 Object Store로 인증 할 수 있어야합니다. Autonomous Data Warehouse에 암호화 된이 정보를 저장하는 사용자의 개인 CREDENTIAL 개체를 생성하면됩니다. 이 정보는 사용자 스키마에만 사용할 수 있습니다.
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbNjQ0NTAzMjQzLDgwODM3MzI0NywtMTI3ND
E0Nzc3OSw3NjMyMDYwMzcsMTk3MDY5MTk1OSwxMjEwMTM5NTBd
fQ==
-->