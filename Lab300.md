...
* OCI Object Storage의 파일을 ADWC에 로드하기 위해서는 사용자 증명(authentication)이 필요합니다. ADWC와 Object Storage간 communication을 위해서는 Swift Protocol을 사용하며 오라클 클라우드에서는 이를 Auth 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTEwNTUyNDQ5MjQsODA4MzczMjQ3LC0xMj
c0MTQ3Nzc5LDc2MzIwNjAzNywxOTcwNjkxOTU5LDEyMTAxMzk1
MF19
-->