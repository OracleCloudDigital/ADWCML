...
-   해미에게 남길 노트를 생성합니다. - 오른쪽 상단의 note 아이콘을 선택하여 다음과 같이 메시지를 남깁니다.  `Hey Heather, can you take a look at these offices and learn why the profit varies so much independent of the customer base?`.
    ...
    ![enter image description here](https://lh3.googleusercontent.com/255s1-1rqbnITWYcnyDD18hbcPgDjBFCiX_9deOYZ-jm95-yqsJ3WKYrWpXpjiSwck9uhL-mJK37 "1")
...
-->
<!--stackedit_data:
eyJoaXN0b3J5IjpbNzc5NDgxMzY1LDcyNTk2NjgyMSwzMTIwNj
