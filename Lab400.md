...
-   마지막으로 CREDIT_SCORING_100K_V의 모든 값을 `Attribute`으로 변경합니다.
...
- 준비 탭으로 이동하고 화면 아래 tab에서  `N1_LIFT_TABLE` 데이터셋을 클릭합니다.
...
-->
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE0Mzk0MzYwNTUsLTExMDQ1MjE5ODQsMT
QyNTE0NTYyNywtMTU0Nzk5MzcyNiwxNjMyNTIyMzM4LDEyMjQ0
Mjc4OTMsNzI1OTY2ODIxLDMxMjA2MzYyNCw3MzM5MzA4OThdfQ
==
-->